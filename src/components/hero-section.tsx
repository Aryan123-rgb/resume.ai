        ...
        <section className="relative w-full overflow-hidden bg-background py-16 sm:py-24 md:py-32 border-b">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-6 sm:space-y-8">
                    {/* Badge */}
                    <Badge variant="secondary" className="px-3 py-1 sm:px-4 sm:py-1.5 text-xs sm:text-sm bg-muted text-foreground">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        <h1 className="text-3xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                            Create{" "}
                            <span className="text-foreground">Professional Resumes</span>{" "}
                            with AI
                        </h1>
                        <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
                            Build stunning resumes in minutes with our AI-powered builder and test your knowledge with interactive quizzes. Stand out from the crowd and land your dream job.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0">
                        ...
                        <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 w-full sm:w-auto" asChild>
                            <Link href="/quiz">
                                Take Quiz <Target className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                            </Link>
                        </Button>
                    </div>
            ...
            <div className="hidden sm:block absolute bottom-10 sm:bottom-20 right-4 sm:right-10 animate-float" style={{ animationDelay: "1s" }}>
